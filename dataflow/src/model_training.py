...
from src.feature_engineering import (dummy_dict, internet_dict, train_yesno_cols, internet_cols, data_transformations)
...
data = data_transformations(data, dummy_dict, internet_dict, train_yesno_cols, internet_cols)
